 ...
 * We emulate the classic Masonry examples, but without multi-column spanning.
 *
...
function makeItems() {
  return [
    ...
    { id: 'i1', height: 90, meta: {} },
    { id: 'i2', height: 70, meta: {} },
...
describe('@masonrykit/browser - basic layout (span=1)', () => {
